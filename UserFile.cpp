...
void UserFile::addUserToFile(User user) {
    ...
    if (numberOfLoadedUsers == 0) {
        ...
        xml.Save("C:\\Users\\smile\\Desktop\\GitHub_nauka\\PersonalBudget_Wioleta\\users.xml");
        xml.OutOfElem(); // back out level
    } else {
        bool bSuccess = xml.Load( "C:\\Users\\smile\\Desktop\\GitHub_nauka\\PersonalBudget_Wioleta\\users.xml" );
